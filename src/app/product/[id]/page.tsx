...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  return (
    <div className={`min-h-screen bg-white ${montserrat.className} text-zinc-900 pb-20 overflow-x-hidden`}>
      ...
      {/* HERO */}
      <div className="max-w-[1440px] mx-auto px-0 md:px-8 py-0 md:py-10 pb-10 md:pb-16">
        <div className="flex flex-col lg:grid lg:grid-cols-12 gap-0 lg:gap-20 items-start">
          ...
          {/* Info */}
          <div className="w-full lg:col-span-5 px-6 md:px-0 pb-10 md:pb-0">
            <ProductInfo
              product={product}
      ...
      {/* Gap: tabs → divider → reviews */}
      <div className="mt-20 md:mt-32 lg:mt-44" />
      <div className="w-full h-px bg-zinc-100 mx-auto max-w-[1200px]" />
      ...
      {/* Gap: reviews → divider → related */}
      <div className="mt-20 md:mt-32 lg:mt-44" />
      <div className="w-full h-px bg-zinc-100 mx-auto max-w-[1200px]" />

      {/* ══ RELATED PRODUCTS ══ */}
      {relatedProducts.length > 0 && (
        <div className="max-w-[1440px] mx-auto px-6 md:px-8 mt-20 md:mt-32 lg:mt-44 mb-20 md:mb-32">
